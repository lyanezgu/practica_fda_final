...
##  2.3. Limpieza de datos - Cambio de nombres de las columnas
...
## 2.4. Limpieza de datos - Cambio de tipo de variable
...
### 6.4.9. Análisis de correlación entre variables númericas
