...
A través de la grafica y de la función cor (valor 0.99 aproximadamente), afirmamos que estás dos variables se correlacionan positivamente. Se aprecia que a nivel general en la gran mayoría de casos, cuando aumenta el coste (sube la variable "mean total payments"), aumenta la cobertura del Medicare (sube también la variable "mean medicare payments").
...
Creamos un sub data set solo con las variables numéricas para analizar si tienes valores atípicos.
...
```
Se observa una correlación positiva en casi todos los casos, excepto para copagas y cobertura.
